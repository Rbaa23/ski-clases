    ...
    <div style={{paddingBottom:20}}>
      ...
      <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(79,195,247,0.2)",borderRadius:14,padding:"14px 16px",marginBottom:12}}>
        ...
        <div style={{display:"flex",justifyContent:"center",marginBottom:12}}>
          <div style={{width:200,height:112,borderRadius:12,background:fondo?`url(${fondo}) 50% 50%/cover no-repeat`:"url(/logo.png?v=1) 50% 50%/auto 45% no-repeat",backgroundPosition:"center",border:"1px solid rgba(79,195,247,0.3)",overflow:"hidden",display:"flex",alignItems:"flex-end",justifyContent:"center"}}>
